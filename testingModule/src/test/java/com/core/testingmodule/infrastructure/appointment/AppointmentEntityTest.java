...
class AppointmentEntityTest {
	...
	void testAllArgsConstructor() {
		AppointmentEntity entity = new AppointmentEntity(id, clientId, nutritionistId, date, status, analysisRequests);
	...
	void testEqualsAndHashCode() {
		AppointmentEntity entity1 = new AppointmentEntity(id, clientId, nutritionistId, date, status, analysisRequests);
		AppointmentEntity entity2 = new AppointmentEntity(id, clientId, nutritionistId, date, status, analysisRequests);
		AppointmentEntity entity3 = new AppointmentEntity(UUID.randomUUID(), clientId, nutritionistId, date, status, analysisRequests);
